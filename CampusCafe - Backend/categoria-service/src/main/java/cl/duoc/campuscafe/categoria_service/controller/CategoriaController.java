...
public class CategoriaController {
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Buscar categoría por ID", description = "Retorna una categoría específica por su ID")
    @ApiResponses(value = {
    ...
    public ResponseEntity<Categoria> crear(
        ...
        Categoria categoria = Categoria.builder().nombre(dto.getNombre()).build();
